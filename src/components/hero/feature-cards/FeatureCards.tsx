...
export const FeatureCards = () => {
  return (
    ...
    >
      <div className="group flex flex-col items-center bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 hover:bg-gray-800/70 transition-all duration-300">
